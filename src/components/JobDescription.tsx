      ...
      <div className="mt-8 bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {sampleJobs.map((job, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-lg p-6 hover:border-blue-300 hover:bg-blue-50 transition-colors cursor-pointer"
            ...
            >
              ...
              <button className="text-blue-900 text-sm font-medium hover:text-blue-700">
                Use this sample →
              </button>
            </div>
          ))}
